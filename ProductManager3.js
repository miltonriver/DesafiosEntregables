...
class ProductsManager {
    constructor(filePath = 'productos3.json') {
        this.products = [];
        this.path = filePath;
        this.loadFromFile('productos3.json');
    }
...
const producto4 = { title: "producto 4", description: "Este es el cuarto producto de prueba", price: 800, thumbnail: "Sin imagen", code: "abc123456", stock: 100 }

const producto5 = { title: "producto 5", description: "Este es el quinto producto de prueba", price: 500, thumbnail: "Sin imagen", code: "abc1234567", stock: 100 }

const producto6 = { title: "producto 6", description: "Este es el sexto producto de prueba", price: 5600, thumbnail: "Sin imagen", code: "abc12345678", stock: 100 }

const producto7 = { title: "producto 7", description: "Este es el séptimo producto de prueba", price: 3200, thumbnail: "Sin imagen", code: "abc1234568", stock: 100 }

const producto8 = { title: "producto 8", description: "Este es el octavo producto de prueba", price: 20, thumbnail: "Sin imagen", code: "abc1234569", stock: 100 }

const producto9 = { title: "producto 9", description: "Este es el noveno producto de prueba", price: 70, thumbnail: "Sin imagen", code: "abc12345689", stock: 100 }

const producto10 = { title: "producto 10", description: "Este es el décimo producto de prueba", price: 890, thumbnail: "Sin imagen", code: "abc12345679", stock: 100 }
